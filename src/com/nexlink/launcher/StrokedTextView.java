...
public class StrokedTextView extends TextView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.StrokedTextView,
                defStyle, 0);
        mStrokeColor = a.getColor(R.styleable.StrokedTextView_strokeColor1, 0xFF000000);
        mStrokeWidth = a.getFloat(R.styleable.StrokedTextView_strokeWidth1, 0.0f);
        mTextColor = a.getColor(R.styleable.StrokedTextView_strokeTextColor1, 0xFFFFFFFF);
        a.recycle();
