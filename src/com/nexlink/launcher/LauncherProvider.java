...
import com.nexlink.launcher.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.nexlink.launcher.settings";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private int loadFavorites(SQLiteDatabase db, int workspaceResourceId) {
            ...
            try {
                ...
                Log.w(TAG, "Got XML exception parsing favorites.", e);
            } catch (IOException e) {
                Log.w(TAG, "Got IO exception parsing favorites.", e);
            } catch (RuntimeException e) {
                Log.w(TAG, "Got Runtime exception parsing favorites.", e);
            }
